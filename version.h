...
#define MINNO_EXE_NAME_STR          "My Program.exe"
...
#define MINNO_README_URL_STR        "https://github.com/MiroKaku/minno/blob/master/README.md"
#define MINNO_LICENSE_URL_STR       "https://github.com/MiroKaku/minno/blob/master/LICENSE"
